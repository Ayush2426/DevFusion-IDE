        ...
        try {
            ...
            const newFileTree = {
                [initialFileId]: {
                    ...
                    name: 'README.md',
                    type: 'file',
                    content: `# ${newProjectObjective}\n\nWelcome to your DevFusion IDE project!\n\nThis is a multi-file environment. You can create files and folders in the explorer on the left.`
                }
            };
        ...
        >
            ...
            >
                <div className="text-center mb-12">
                    ...
                    >
                        ~developed and built by <span className="text-blue-300 font-semibold">Ayush Verma@2025 | Project08</span>
                    </motion.h6>
                </div>
